...
namespace Coulomb8.Annihilators.C012
open scoped BigOperators

def integers : Fin 102 → IP := ![[],[],[2],[],[-2],[],[],[],[],[],[],[],[],[],[6],[-6],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]]

theorem scale_checked : List.ofFn CoefficientMatrix.column12=
...
theorem annihilates0 : ∑ r, L0 r*K.eval (CoefficientMatrix.column12 r)=0 :=
  scaled_annihilator l0 integers _ _ 2 scale_checked checked0

theorem annihilates1 : ∑ r, L1 r*K.eval (CoefficientMatrix.column12 r)=0 := by
  simpa only [L1,div_one] using scaled_annihilator l1 integers _ _ 1 scale_checked checked1

theorem structural_zero : K.eval (CoefficientMatrix.column12 57)=0 := by rfl

end Coulomb8.Annihilators.C012
