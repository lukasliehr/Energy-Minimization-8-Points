...
namespace Coulomb8.Columns.C003
...
theorem checked :
    (Poly.add (Data.F0.upperColumn 0 3)
      (Poly.scale (K.ofRat (-1)) (expandColumn coefficients))).isZero := by
  decide +kernel

theorem sound (u v t : ℝ) :
    (Data.F0.upperColumn 0 3).eval u v t =
      (expandColumn coefficients).eval u v t :=
  Poly.eval_eq_of_check _ _ checked u v t

end Coulomb8.Columns.C003

#print axioms Coulomb8.Columns.C003.sound
