...
namespace Coulomb8.Columns.C020
...
def r25 : ℚ := { num := 2048, den := 35, den_nz := by decide +kernel, reduced := by decide +kernel }
def r26 : ℚ := { num := -4608, den := 35, den_nz := by decide +kernel, reduced := by decide +kernel }
def r27 : ℚ := { num := 4096, den := 35, den_nz := by decide +kernel, reduced := by decide +kernel }
def r28 : ℚ := { num := -256, den := 7, den_nz := by decide +kernel, reduced := by decide +kernel }
def r29 : ℚ := { num := -768, den := 35, den_nz := by decide +kernel, reduced := by decide +kernel }
def r30 : ℚ := { num := 768, den := 5, den_nz := by decide +kernel, reduced := by decide +kernel }
def r31 : ℚ := { num := -2304, den := 7, den_nz := by decide +kernel, reduced := by decide +kernel }

noncomputable def coefficients : List K := [[],[],[],[],[],[r0,r1,r2,r3,r4],[r5,r6,r7,r8],[r9,r10,r11,r12,r13],[r14,r15,r16,r17],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[r14,r18,r19,r20,r21],[r22,r23,r24,-256],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[r5,r25,r26,r27,r28],[r29,r30,r31,256],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]]

theorem checked :
    (Poly.add (Data.F1.upperColumn 2 3)
      (Poly.scale (K.ofRat (-1)) (expandColumn coefficients))).isZero := by
  decide +kernel

theorem sound (u v t : ℝ) :
    (Data.F1.upperColumn 2 3).eval u v t =
      (expandColumn coefficients).eval u v t :=
  Poly.eval_eq_of_check _ _ checked u v t

end Coulomb8.Columns.C020

#print axioms Coulomb8.Columns.C020.sound
