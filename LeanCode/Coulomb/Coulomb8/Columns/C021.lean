...
namespace Coulomb8.Columns.C021
...
def r18 : ℚ := { num := 768, den := 35, den_nz := by decide +kernel, reduced := by decide +kernel }
def r19 : ℚ := { num := -768, den := 5, den_nz := by decide +kernel, reduced := by decide +kernel }
def r20 : ℚ := { num := 2304, den := 7, den_nz := by decide +kernel, reduced := by decide +kernel }
def r21 : ℚ := { num := 128, den := 7, den_nz := by decide +kernel, reduced := by decide +kernel }
def r22 : ℚ := { num := -1408, den := 7, den_nz := by decide +kernel, reduced := by decide +kernel }
def r23 : ℚ := { num := 5888, den := 7, den_nz := by decide +kernel, reduced := by decide +kernel }
def r24 : ℚ := { num := -4224, den := 5, den_nz := by decide +kernel, reduced := by decide +kernel }
...
noncomputable def coefficients : List K := [[],[],[],[],[],[r0,r1,r2,r3,640,r4],[],[r5,r6,r7,r8,-640,r9],[],[r10,r11,r12,r13],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[r14,r15,r16,1792,-1920,r17],[],[r18,r19,r20,-256],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[r21,r22,r23,-1792,1920,r24],[],[r25,r26,r27,256],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[],[]]

theorem checked :
    (Poly.add (Data.F1.upperColumn 2 4)
      (Poly.scale (K.ofRat (-1)) (expandColumn coefficients))).isZero := by
  decide +kernel

theorem sound (u v t : ℝ) :
    (Data.F1.upperColumn 2 4).eval u v t =
      (expandColumn coefficients).eval u v t :=
  Poly.eval_eq_of_check _ _ checked u v t

end Coulomb8.Columns.C021

#print axioms Coulomb8.Columns.C021.sound
